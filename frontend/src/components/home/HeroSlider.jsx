                  ...
                  <div className="container mx-auto px-4 sm:px-6 h-full flex flex-col-reverse lg:flex-row items-center justify-center relative pb-32 pt-0 lg:pt-0 lg:pb-24">
                    ...
                    <div className="w-full lg:w-[45%] z-40 flex flex-col justify-end lg:justify-center items-center lg:items-start text-center lg:text-left h-auto lg:h-full mt-[-20px] lg:mt-0 relative">
                      ...
                      >
                        {/* ROLE BADGE */}
                        <div
                          className={`inline-flex items-center gap-2 md:gap-3 px-3 py-1.5 md:px-4 md:py-2 rounded-full border bg-slate-900/80 backdrop-blur-md ${theme.border} mb-4 md:mb-6 lg:mb-10 group shadow-lg`}
                        >
                          ...
                          <span
                            className={`text-[10px] md:text-xs font-mono font-bold tracking-[0.2em] uppercase text-slate-300 group-hover:${theme.text} transition-colors`}
                          >
                            {member.role}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3 md:gap-4 lg:gap-5 justify-center lg:justify-start items-center w-full px-1 pb-10 lg:pb-0">
                          ...
                          >
                            ...
                            >
                              <div
                                className={`absolute inset-0 bg-gradient-to-r ${theme.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                              ></div>
                    ...
                    <div className="w-full lg:w-[55%] h-[50vh] lg:h-full relative flex items-end justify-center perspective-1000 pt-0 lg:pt-0 z-10">
                      ...
                      >
                        ...
                        <div className="absolute top-[20%] lg:top-[20%] left-1/2 -translate-x-1/2 w-[250px] h-[250px] md:w-[400px] md:h-[400px] lg:w-[600px] lg:h-[600px] border border-white/5 rounded-full animate-[spin_20s_linear_infinite]">
                          <div
                            className={`absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 md:w-2 md:h-2 rounded-full box-shadow-glow`}
                            style={{
...
const FloatingCard = ({ icon, text, delay, position, theme }) => (
  ...
  >
    <div
      className={`p-1.5 md:p-2 lg:p-2.5 rounded-lg md:rounded-xl bg-gradient-to-br ${theme.gradient} text-white shadow-lg`}
    >
      <span className="text-xs md:text-sm lg:text-base">{icon}</span>
    </div>
    <div>
      <span className="block text-[8px] md:text-[9px] lg:text-[10px] text-slate-400 uppercase tracking-wider font-bold">
        Expertise
      </span>
      <span className="block text-xs md:text-xs lg:text-sm font-bold text-white whitespace-nowrap">
        {text}
      </span>
    </div>
  </motion.div>
